label prolog2_scene2:
    ...
    show aisyah kemeja_bicara with dissolve:
        zoom 0.3 xalign 0.8 yalign 6.0
    ...
    #Aisyah hilang
    hide aisyah kemeja_senyum with dissolve
    ...
    show aisyah kemeja_bicara with dissolve:
        zoom 0.3 xalign -0.1 yalign 6.0
    ...
    menu:
        "\"Yang kamu maksud kerja paling banyak itu, dia ketua yang bertanggungjawab di banyak hal, kan?\"":
            jump prolog2_scene2_after_choice1
        "\"Dia beneran kerja sendirian?!\"":
            jump prolog2_scene2_after_choice1

label prolog2_scene2_after_choice1:
    ...
    show raden ngomong
    raden "\"Kamu dengerin kita bicara dari tadi?\""

    show aisyah kemeja_bicara
    aisyah "\"Aku juga mau bantu kamu, Santo.. kan ya?\""

    santo "\"Kalian gak usah repot-repot lah.\""

    show raden senyum sadar
    raden "\"Gak masalah, aku bakalan ngikutin kamu, jadi mau gak mau kamu bakalan nerima bantuan kami.\""

    santo "\"Yaudahlah, oke kalau begitu.\""
