...
# Suasana : Netral di Kampus
    ...
    "Setelah itu, aku melakukan pengecekan barang, lalu buru-buru menuju Auditorium, agar tidak ketinggalan banyak materi yang harus dicatat."

    jump prolog_day3_scene2
